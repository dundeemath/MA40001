...
In Quarto, objects are tagged using a specific syntax (prefix for that specific obect + unique tag). See @tbl-syntax for some examples. Such objects can then be cross referenced using an `@' tag.
