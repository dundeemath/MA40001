...
- simultaneuosly generate multiple output formats
...
It is advised that you get VS Code + ncessary software running on your personal computer.
 ...
 * install Latex (follow these [guidelines](https://quarto.org/docs/output-formats/pdf-basics.html)).
